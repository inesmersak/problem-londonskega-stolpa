...
\begin{frame}{Ravninskost grafa}
    \begin{figure}[h]
        ...
        \caption{Vsi londonski grafi s $p=3$ in $n=2$ so ravninski. Prikazani so: $L^2_{111}, L^2_{112}, L^2_{122}$ in $L^2_{222} = O^2_3$.}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{block}{Trditev}
           	Naj bo $p=3$. Tedaj so ravninski londonski grafi $L_h^2, L_{122}^3,L_{123}^3 = L$ in $ L_{133}^3$.
    \end{block}

    \begin{figure}[h]
        %\includegraphics[width=170pt]{}
        \caption{Graf $K_{3,3}$ je toroidalen.}
    \end{figure}
\end{frame}
