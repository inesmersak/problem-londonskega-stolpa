...
Preden si ogledamo formulo za število povezav londonskega grafa, pa si na hitro oglejmo še sledečo lemo, ki jo bomo potrebovali pri dokazu formule za število povezav:
...
\begin{proof}
    ...
    Leva stran enakosti nam predstavlja vse možne načine, kako lahko izberemo $l$ krogel izmed $b+w$ krogel (brez vračanja). 
...
\begin{proof}
    ...
    Za dokaz formule bomo potrebovali še sledečo formulo za binomske simbole, ki jo privzemimo kot znano [bolje dokaz -- TODO]:
