...
\emph{Sprehod} v grafu $G$ je tako zaporedje vozlišč $v_1, v_2, \ldots, v_k$, da velja $v_i v_{i+1} \in E(G),$ pri čemer je $1 \leq i \leq k-1$. Če označimo $x = x_1$ in $y = x_k$, potem takemu sprehodu rečemo $x,y$-sprehod.
